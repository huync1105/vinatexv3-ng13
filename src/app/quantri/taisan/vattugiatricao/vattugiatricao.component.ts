...
@Component({
  selector: 'app-vattugiatricao',
  templateUrl: './vattugiatricao.component.html',
  styleUrls: ['./vattugiatricao.component.css']
})
export class VattugiatricaoComponent implements OnInit {
