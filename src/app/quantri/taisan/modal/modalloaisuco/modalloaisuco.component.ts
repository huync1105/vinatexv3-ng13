...
@Component({
  selector: 'app-modalloaisuco',
  templateUrl: './modalloaisuco.component.html',
  styleUrls: ['./modalloaisuco.component.css']
})
export class ModalloaisucoComponent implements OnInit {
