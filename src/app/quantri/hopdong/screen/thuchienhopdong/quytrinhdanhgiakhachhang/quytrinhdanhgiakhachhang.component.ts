...
import { QuytrinhdanhgiakhachhangmodalComponent } from './quytrinhdanhgiakhachhangmodal/quytrinhdanhgiakhachhangmodal.component';

@Component({
  selector: 'app-quytrinhdanhgiakhachhang',
  templateUrl: './quytrinhdanhgiakhachhang.component.html',
  styleUrls: ['./quytrinhdanhgiakhachhang.component.css']
})
export class QuytrinhdanhgiakhachhangComponent implements OnInit {
  ...
  eAction: any = "QUYTRINHDANHGIAKHACHHANG";
  listHopDong: any = [];
  IdDuAn: any = 0;
  ...
  changeParam(id) {
    ...
    this.router.navigate([`quantri/hopdongsanxuat/danhgiakhachhang/${id}`], { replaceUrl: true })
  }
