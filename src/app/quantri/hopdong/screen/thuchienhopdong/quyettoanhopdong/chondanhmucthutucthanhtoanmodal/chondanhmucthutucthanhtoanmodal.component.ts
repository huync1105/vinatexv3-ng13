...
@Component({
  selector: 'app-chondanhmucthutucthanhtoanmodal',
  templateUrl: './chondanhmucthutucthanhtoanmodal.component.html',
  styleUrls: ['./chondanhmucthutucthanhtoanmodal.component.css']
})
export class ChondanhmucthutucthanhtoanmodalComponent implements OnInit {
  item: any = {};
