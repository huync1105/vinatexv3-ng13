...
@Component({
  selector: 'app-xuatkhothanhphamhopdong',
  templateUrl: './xuatkhothanhphamhopdong.component.html',
  styleUrls: ['./xuatkhothanhphamhopdong.component.css']
})
export class XuatkhothanhphamhopdongComponent implements OnInit {
  ...
  add() {
    this.changeParam(0);
    let modalRef = this._modal.open(ChitietxuatkhothanhphamhopdongComponent, {
      size: 'fullscreen',
      backdrop: 'static'
    })
