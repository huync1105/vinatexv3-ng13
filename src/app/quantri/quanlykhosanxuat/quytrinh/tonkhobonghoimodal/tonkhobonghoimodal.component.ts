...
@Component({
  ...
  templateUrl: './tonkhobonghoimodal.component.html',
  styleUrls: ['./tonkhobonghoimodal.component.css']
})
export class TonkhobonghoimodalComponent implements OnInit {
  ...
  mapXuatNhapRoute = {
    Xuat: '/quantri/quanlykhosanxuatbongkhac/khobonghoi/xuatkho/',
    Nhap: '/quantri/quanlykhosanxuatbongkhac/khobonghoi/nhapkho/',
    KiemKe: '/quantri/quanlykhosanxuat/khobonghoi/kiemkekhobonghoi/'
  }
