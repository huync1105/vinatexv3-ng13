...
@Component({
  selector: 'app-nhaphoiammathangmodal',
  templateUrl: './nhaphoiammathangmodal.component.html',
  styleUrls: ['./nhaphoiammathangmodal.component.css']
})
export class NhaphoiammathangmodalComponent implements OnInit {
  listMatHang: any = [];
  listItem: any = [];
  cols: any = [
    {
