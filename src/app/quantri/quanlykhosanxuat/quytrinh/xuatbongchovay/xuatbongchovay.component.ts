...
import { XuatbongchovaymodalComponent } from './xuatbongchovaymodal/xuatbongchovaymodal.component';

@Component({
  selector: 'app-xuatbongchovay',
  templateUrl: './xuatbongchovay.component.html',
  styleUrls: ['./xuatbongchovay.component.css']
})
export class XuatbongchovayComponent implements OnInit {
  ...
  changeParam(id) {
    ...
    this.router.navigate([`quantri/quanlykhosanxuat/xuatbongchovay/khobong/${id}`], { replaceUrl: true })
  }
  add() {
    let modalRef = this._modal.open(XuatbongchovaymodalComponent, {
      size: 'fullscreen',
      backdrop: 'static'
    })
  ...
  GetListQuyTrinh(reset?) {
    ...
    this._service.PhieuXuatBongChoVay().GetList(data).subscribe((res: any) => {
